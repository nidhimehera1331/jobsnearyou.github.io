...
<div class="product-item bg-light">
	<div class="card">
		<div class="thumb-content">
			...
			<a href="productdetail.php?id=<?php echo $row['pro_id'];  ?>">
				<img class="card-img-top img-fluid" src="<?php echo $row['pro_image1'];  ?>" alt="Card image cap">
			</a>
		</div>
		<div class="card-body">
		    <h4 class="card-title"><a href="productdetail.php?id=<?php echo $row['pro_id'];  ?>"><?php echo $row['pro_name'];  ?></a></h4>
